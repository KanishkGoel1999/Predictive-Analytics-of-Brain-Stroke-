...
```{r Chi-Square Test to determine if brain ever-married and age are independent}
# Chi-squared test of ever_married and age
...
```
<br/>
This depicts body mass index and stroke are normally distributed.<br/>
...
```
<br/>
Distribution for average glucose level and stroke rightly skewed
