...
The data of average glucose level is wide spread compared to age and BMI. A higher variance indicates that the data points are more spread out from the mean, glucose is more spread from mean compared to age and BMI.
