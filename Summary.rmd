...
<br/>Yao, Q., Zhang, J., Yan, K., Zheng, Q., Li, Y., Zhang, L., Wu, C., Yang, Y., Zhou, M., & Zhu, C. (2020). Development and validation of a 2-year new-onset stroke risk prediction model for people over age 45 in China. Medicine, 99(41), e22680. https://doi.org/10.1097/MD.0000000000022680
<br/>Wang, Q., Zhang, L., Li, Y., Tang, X., Yao, Y., & Fang, Q. (2022). Development of a stroke predictive model in the community-dwelling population: A longitudinal cohort study in Southeast China. Frontiers in Aging Neuroscience, 14, Article 1036215. https://doi.org/10.3389/fnagi.2022.1036215
